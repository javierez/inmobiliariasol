    ...
    <div className="space-y-4">
      ...
      >
        ...
        <Button
          variant="outline"
          size="icon"
          className="absolute right-5 top-5 h-11 w-11 rounded-full border-0 bg-white/95 text-foreground shadow-lg backdrop-blur-md transition-all hover:bg-white hover:scale-105"
          onClick={() => setIsFullscreen(true)}
