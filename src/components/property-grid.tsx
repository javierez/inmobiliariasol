...
export async function PropertyGrid() {
  ...
  const { title, subtitle, buttonText, showDescription } = config;
    ...
    <PropertyGridWrapper>
      <section className="py-24 sm:py-28 lg:py-32" id="properties">
        <div className="container">
          ...
          <PropertyGridContent listings={listings} watermarkEnabled={watermarkEnabled} showDescription={showDescription} />
