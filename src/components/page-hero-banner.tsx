        ...
        <>
          <div className="absolute inset-0 z-0 h-full w-full">
            <video
              ...
              // La imagen de portada de la sección deja de ser papel mojado
              // cuando además hay vídeo: sirve de primer fotograma mientras el
              // mp4 carga y de fallback si el navegador bloquea el autoplay.
