    ...
    if (existingContact) {
      ...
      const [newContact] = await db
        ...
        .values({
          ...
          // Mismas reglas de reparto que un lead de portal. Sin anuncio que
          // mande, cae en el reparto equitativo de la cuenta.
          assignedTo: await resolveWebLeadAgent({ accountId }),
          additionalInfo: {
