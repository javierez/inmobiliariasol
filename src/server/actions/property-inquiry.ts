...
import { resolveWebLeadAgent } from "~/server/lead-assignment";
    ...
    if (existingContact) {
      ...
      const [newContact] = await db
        ...
        .values({
          ...
          source: 'Website',
          // Mismas reglas de reparto que un lead de portal. El anuncio manda:
          // en modo `listing_agent` la consulta va a quien lo tiene asignado.
          assignedTo: await resolveWebLeadAgent({
            accountId,
